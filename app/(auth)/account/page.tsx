...
export default function SignUp() {
  ...
  const getUserId = (email: string, password: string) => {
    fetch('https://pasarmaya-api.agilf.dev/api/auth/Login', {
      method: 'POST',
      headers: {
  ...
  const handleDeleteUser = (userId: string) => {
    fetch(`https://pasarmaya-api.agilf.dev/api/User/${userId}`, {
      method: 'DELETE',
      headers: {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            ...
            {/*  Already using Pasar-Maya? <Link href="/signin" className="text-blue-600 hover:underline transition duration-150 ease-in-out">Sign in</Link>*/}
            {/*</div>*/}
          </div>
